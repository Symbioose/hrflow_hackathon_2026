...
export const DEMO_PROFILES: SourcedProfile[] = [
  ...
  // ─── GitHub ────────────────────────────────────────────────────
  {
    ...
    location: "Paris, Île-de-France",
    experience_years: 15,
    summary: "ML Engineer chez :probabl et lead technique de la fondation scikit-learn — l'une des librairies ML les plus utilisées au monde (200k+ étoiles GitHub). Core contributor depuis 2010. Enseigne le deep learning à l'École Polytechnique et Paris-Saclay. Profil GitHub rare : praticien de haut niveau avec une empreinte open source massive et vérifiable.",
    sources: [
      { type: "github", url: "https://github.com/ogrisel", label: "github.com/ogrisel" },
      { type: "linkedin", url: "https://www.linkedin.com/in/oliviergrisel/", label: "linkedin.com/in/oliviergrisel" },
    ],
    skills: ["Python", "scikit-learn", "NumPy", "NLP", "Text Mining", "Deep Learning", "CUDA", "PyTorch", "Cython", "Open Source"],
    experiences: [
      {
        ...
        location: "Paris",
        period: "2023 — Présent",
        description: "Lead technique de la fondation scikit-learn. Développement et maintenance de scikit-learn (200k+ étoiles GitHub, des millions d'utilisateurs). Enseignement deep learning à l'École Polytechnique.",
      },
      {
        title: "Machine Learning Engineer",
        company: "Inria",
        location: "Paris",
        period: "2011 — 2023",
        description: "Core contributor scikit-learn pendant 12 ans. Développement des modules text mining, SVM, et parallel computing. Expert en optimisation de code ML en Python/Cython/CUDA.",
      },
    ],
    educations: [
      { degree: "MSc Advanced Computing", school: "Imperial College London", period: "2006 — 2007" },
      { degree: "Diplôme d'ingénieur", school: "ENSTA ParisTech", period: "2003 — 2006" },
    ],
    hrflow_score: 79,
    hrflow_key: null,
    avatar_color: "#1f2937",
