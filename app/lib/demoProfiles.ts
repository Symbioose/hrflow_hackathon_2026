...
export const DEMO_PROFILES: SourcedProfile[] = [
  // ─── LinkedIn ──────────────────────────────────────────────────
  {
    key: "demo-camille-fontaine",
    name: "Camille Fontaine",
    title: "Lead Data Scientist — Criteo",
    location: "Paris, Île-de-France",
    experience_years: 7,
    summary: "Lead Data Scientist chez Criteo avec 7 ans d'expérience en ML appliqué à la performance publicitaire. Spécialisée en modèles de recommendation et prédiction d'intention d'achat à grande échelle (10M+ prédictions/jour). Ancienne consultante ML chez Artefact. Maîtrise complète du cycle MLOps — de l'expérimentation jusqu'au déploiement en production.",
    sources: [{ type: "linkedin", url: "https://www.linkedin.com/in/camille-fontaine-datascience/", label: "linkedin.com/in/camille-fontaine-datascience" }],
    skills: ["Python", "PyTorch", "XGBoost", "MLflow", "Spark", "Airflow", "SQL", "Kubernetes", "A/B Testing", "Recommendation Systems"],
    experiences: [
      {
        ...
        location: "Paris",
        period: "2021 — Présent",
        description: "Lead d'une équipe de 4 data scientists. Développement de modèles de prédiction d'intention d'achat (uplift modeling). Réduction du coût d'acquisition de 18% grâce au passage de XGBoost à un réseau neuronal custom. Stack : PyTorch, Spark, MLflow, Kubernetes.",
      },
      {
        ...
        location: "Paris",
        period: "2018 — 2021",
        description: "Consulting ML pour des clients grands comptes (retail, banque). Projets de churn prediction, segmentation client, NLP sur données contractuelles. Livraison de modèles en production sur GCP et Azure.",
      },
      {
        title: "Data Analyst",
        ...
        location: "Paris",
        period: "2017 — 2018",
        description: "Analyse prédictive sur données de risque crédit. Premier poste en sortie d'école.",
      },
    ],
    educations: [
      { degree: "MSc Data Science & Machine Learning", school: "CentraleSupélec", period: "2015 — 2017" },
      { degree: "Classe préparatoire MPSI/MP", school: "Lycée Louis-le-Grand", period: "2013 — 2015" },
    ],
    hrflow_score: 94,
    hrflow_key: null,
    avatar_color: "#0077b5",
