# Pitch Deck Hackathon (4 minutes) - Inspiré par Juicebox (PeopleGPT)

**Thèse Juicebox (Levée de 80M$) :** Le recrutement moderne ne se fait plus par des offres d'emploi (inbound), il se fait par la chasse proactive (outbound). Les meilleurs talents ne cherchent pas de travail. L'IA permet d'automatiser cette chasse à une échelle humaine.

Voici la structure de tes slides pour une présentation percutante de 4 minutes :

## Slide 1 : Le Hook (Le Problème)
- **Visuel :** Un recruteur noyé sous les CVs + un dev génial caché dans l'ombre.
- **Message :** Le recrutement est cassé. 80% du temps d'un recruteur est perdu à trier des CVs médiocres ou à taper des requêtes booléennes complexes sur LinkedIn. 
...
- **Message :** Trouver le candidat ne suffit pas, il faut lui parler. Notre IA génère un message d'approche hyper-personnalisé basé sur l'analyse de son profil web (ex: "J'ai vu votre dernier commit sur React...").
- **Stat Juicebox :** L'approche ultra-personnalisée par IA génère 3x plus de réponses.

## Slide 6 : Marché et Conclusion
- **Visuel :** Le logo de Juicebox avec la mention "$80M Series B" barré avec votre logo à côté.
- **Message :** Le marché valide cette approche : Juicebox vient de lever 80M$ sur ce modèle exact aux US. Nous avons construit l'alternative européenne, propulsée par HrFlow, en 48 heures.
- **Call to action :** "Ne cherchez plus les talents, laissez l'IA vous les amener."
